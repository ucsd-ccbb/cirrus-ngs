...
/**
 * ConfigLoader loads the configuration file which contains all paths of the tools 
 * and parameters used in the pipeline.
 * @author	Guorong Xu
 */
public class ConfigLoader {
	...
	public void parsePathFile(String file) throws Exception
	{
		...
		{
			Date date= new Date();
			System.err.println(new Timestamp(date.getTime()) + stringLine);
		}
	}
