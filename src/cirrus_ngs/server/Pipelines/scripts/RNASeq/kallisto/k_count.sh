...
# TODO: Call the perl file
# command: perl $count_script $output_file
check_exit_status "perl $kallisto_counts $workspace/$fastq_end1"_counts.txt"" $JOB_NAME $status_file
