...
WGSPipelineManager.execute(ssh_client, "project_name", ["hello"], "s3://ucsd-ccbb-interns/Mustafa/wgs_test/Sample_cDNA", [['Sample_cDNA93_R1.fq.gz', 'Sample_cDNA93_R2.fq.gz'], ['Sample_cDNA94_R1.fq.gz', 'Sample_cDNA94_R2.fq.gz']], ['groupA', "groupB"], "s3://ucsd-ccbb-interns/Mustafa/wgs_test/Sample_cDNA", "")
print("done")
